...
class WebWizardChat {
        ...
        <div class="chat-window" id="chatWindow">
          ...
          <div class="chat-input-container">
            <div class="input-wrapper">
              <textarea 
                id="chatInput" 
                placeholder="Ask me anything about WebWizard"
                rows="1"
              ></textarea>
  ...
  async sendMessageToAI(userMessage) {
    return await this.sendMessageToMistral(userMessage);
  }

  async sendMessageToMistral(userMessage) {
    const MISTRAL_API_KEY = 'yD7Vgdw6gvbjrOAMyx5Xj6RMRSYrAjJW';
    const siteContext = `
You are WebWizard AI, the official AI assistant for the WebWizard website.
Your main purpose is to help users with anything related to this website, its services, or digital solutions.
Always answer as a helpful, knowledgeable, and friendly assistant representing WebWizard.
**Use as few words as possible. Give ultra-concise, minimal answers unless the user asks for more detail.**
Website summary:
- WebWizard offers web development, AI solutions, digital consulting, and portfolio services for individuals and businesses.
- The website features a modern gold-on-black color scheme for a premium, elegant look.
- Main pages: Home, Services, Portfolio, Testimonials, Contact, Privacy Policy, Terms of Service.
- WebWizard specializes in creating custom websites, e-commerce stores, business sites, and AI-powered digital solutions.
- The site includes real client testimonials, a showcase of past projects, and easy ways to get in touch for quotes or consultations.
- WebWizard values quality, innovation, and customer satisfaction.
`;
    ...
    if (
      ...
      return 'Mistral API error: ' + data.error.message;
    } else {
      return 'Sorry, I could not get a response from Mistral.';
    }
  }
